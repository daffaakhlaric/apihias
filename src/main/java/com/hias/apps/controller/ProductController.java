...
//        float totalPrice;
        JSONObject result = new JSONObject();
        List<ProductPilihan> listHotProduct = productPilihanService.getPopupCartProduct();
        for(ProductPilihan objects : listHotProduct) {
            JSONObject json = new JSONObject();
//            TotalAfterDiscount = objects.getPrice()*objects.getDiscount()/100;
//            totalPrice = objects.getPrice()-TotalAfterDiscount;
            ...
            json.put("discount", objects.getProduct().getDiscount());
            json.put("price", objects.getProduct().getPrice());
            json.put("itemStock", objects.getProduct().getQuantity());
            json.put("thumbnail",objects.getProduct().getThumNailUrl());

            json.put("category",mainCategory);
            mainCategory.put("id",objects.getProduct().getMiniSubCategoryProperties().getId());
            mainCategory.put("name",objects.getProduct().getMiniSubCategoryProperties().getCategoryname());
    ...
    @GetMapping("productPilihan")
    public ResponseEntity<?> productPilihan() {

        JSONObject resp = new JSONObject();
        List<JSONObject> listSub = new ArrayList<>();
//        float totalPrice;
        JSONObject result = new JSONObject();
        List<ProductPilihan> listHotProduct = productPilihanService.getProductPilihanHome();
        for(ProductPilihan objects : listHotProduct) {
            JSONObject json = new JSONObject();
//            TotalAfterDiscount = objects.getPrice()*objects.getDiscount()/100;
//            totalPrice = objects.getPrice()-TotalAfterDiscount;
            ...
            json.put("productId", objects.getProduct().getId());
            json.put("productPilihanId", objects.getId());
            json.put("itemStock", objects.getProduct().getQuantity());
            json.put("productName", objects.getProduct().getName());
            json.put("discount", objects.getProduct().getDiscount());
            json.put("price", objects.getProduct().getPrice());
...
//    public Iterable<Product> filterProductByColor(
//            @Spec(path = "firstName", spec = Like.class) NotDeletedCustomerSpecification spec) {
//
//        return productService.findAll(spec);
//    }

    @GetMapping("getAllProductPilihan")
    public ResponseEntity<?> getALLproductPilihan(Pageable pageable) {

        JSONObject resp = new JSONObject();
        List<JSONObject> listSub = new ArrayList<>();
//        float totalPrice;
        JSONObject result = new JSONObject();
        Page<ProductPilihan> listHotProduct = productPilihanService.getProductPilihanAll(pageable);
        for(ProductPilihan objects : listHotProduct) {
            JSONObject json = new JSONObject();
//            TotalAfterDiscount = objects.getPrice()*objects.getDiscount()/100;
//            totalPrice = objects.getPrice()-TotalAfterDiscount;
...
//            json.put("courier", existingProduct.getCourier());
            ...
            json.put("itemStock", existingProduct.getQuantity());
...
//            listMiniSubCategory.put("name",existingProduct.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    @GetMapping("{id}/aToz")
    public ResponseEntity<?> filterAtoZ(@PathVariable (value = "id") Long Id) {
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    @GetMapping("{id}/colorRed")
    public ResponseEntity<?> filterColorRed(@PathVariable (value = "id") Long Id) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        List<Product> listHotProduct = productService.getColorRed(Id);
        for(Product objects : listHotProduct) {
            JSONObject json = new JSONObject();
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
...
//            JSONObject json = new JSONObject();
            ...
            json.put("productName", objects.getName());
            json.put("price", objects.getPrice());
            json.put("color", objects.getColor());
            json.put("discount", objects.getDiscount());
            json.put("itemStock", objects.getQuantity());
            json.put("thumbnail",objects.getThumNailUrl());
            json.put("categoryName",objects.getMiniSubCategoryProperties().getCategoryname());
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    @GetMapping("{id}/diskon")
    public ResponseEntity<?> filterDiskon(@PathVariable (value = "id") Long Id) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        List<Product> listHotProduct = productService.getDiskon(Id);
        for(Product objects : listHotProduct) {
            JSONObject json = new JSONObject();
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    @GetMapping("{id}/{color}")
    public ResponseEntity<?> findAllColor(@PathVariable (value = "id") Long Id,@PathVariable (value = "color") String color) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        List<Product> listHotProduct = productService.getAllColot(Id,color);
        for(Product objects : listHotProduct) {
            JSONObject json = new JSONObject();
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    @GetMapping("{id}/colorGreen")
    public ResponseEntity<?> filterColorGreen(@PathVariable (value = "id") Long Id) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        List<Product> listHotProduct = productService.getColorGreen(Id);
        for(Product objects : listHotProduct) {
            JSONObject json = new JSONObject();
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    @GetMapping("{id}/colorBlue")
    public ResponseEntity<?> filterColorBlue(@PathVariable (value = "id") Long Id) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        List<Product> listHotProduct = productService.getColorBlue(Id);
        for(Product objects : listHotProduct) {
            JSONObject json = new JSONObject();
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    @GetMapping("{id}/colorBlack")
    public ResponseEntity<?> filterColorBlack(@PathVariable (value = "id") Long Id) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        List<Product> listHotProduct = productService.getColorBlack(Id);
        for(Product objects : listHotProduct) {
            JSONObject json = new JSONObject();
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    @GetMapping("{id}/colorWhite")
    public ResponseEntity<?> filterColorWhite(@PathVariable (value = "id") Long Id) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        List<Product> listHotProduct = productService.getColorWhite(Id);
        for(Product objects : listHotProduct) {
            JSONObject json = new JSONObject();
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    public ResponseEntity<?> seacrchName(@PathVariable (value = "name") String name,Pageable pageable) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        Page<Product> listHotProduct = productService.getListSearchProduct(name,pageable);
        for(Product objects : listHotProduct) {
            JSONObject json = new JSONObject();
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    public ResponseEntity<?> productByCategoryId(@PathVariable (value = "id") Long id, Pageable pageable) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        Page<Product> listHotProduct = productService.getProductBySubCategoryId(id,pageable);
        for(Product objects : listHotProduct) {
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
            JSONObject superMiniSubCategory = new JSONObject();
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    @GetMapping("relatedCategoryId/{id}")
    public ResponseEntity<?> productRelated(@PathVariable (value = "id") Long id) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        List<Product> listHotProduct = productService.getRelatedList(id);
        for(Product objects : listHotProduct) {
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
            JSONObject superMiniSubCategory = new JSONObject();
...
//            listMiniSubCategory.put("name",objects.getMiniSubCategoryProperties().getMiniSubCategoryProperties().getCategoryname());
    ...
    public ResponseEntity<?> getAllDiscount(Pageable pageable) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        Page<Product> listHotProduct = productService.getAllDiscount(pageable);
        for(Product objects : listHotProduct) {
            JSONObject listSubCategory = new JSONObject();
            JSONObject listMiniSubCategory = new JSONObject();
            JSONObject superMiniSubCategory = new JSONObject();
...
//            json.put("date", objects.getCreatedAt());
    ...
    public ResponseEntity<?> getByWishlistId(@PathVariable(value = "id") Long Id) {
        ...
        for(Wishlist objects : listHotProduct) {
            JSONObject json = new JSONObject();
            JSONObject listUser = new JSONObject();
            json.put("id", objects.getProduct().getId());
            json.put("productName", objects.getProduct().getName());
            json.put("idWishlist", objects.getId());
            json.put("price", objects.getProduct().getPrice());
            json.put("itemStock", objects.getProduct().getQuantity());
            json.put("discount", objects.getProduct().getDiscount());
            json.put("thumbnail",objects.getProduct().getThumNailUrl());
    ...
    public ResponseEntity<?> getRelated(@PathVariable(value = "id") Long id) {
        ...
        for(RelatedProduct objects : listHotProduct) {
            ...
            json.put("discount", objects.getProductRelated().getDiscount());
            json.put("category",mainCategory);
...
//    }
    ...
    public  ResponseEntity<?>  getAddToCart(@PathVariable (value = "id") Long id) {
        ...
        for(CartItem objects : listHotProduct) {
            ...
            json.put("discount",objects.getCartProduct().getDiscount());
...
//    }
    ...
    public ResponseEntity<Long> createVehicle(@RequestBody OrderDto orderDto) throws IOException {

//            orderDto.getUserId();
        jsonArrayString = String.valueOf(orderDto.getProductItem());
        ObjectMapper objectMapper = new ObjectMapper();
...
//        ProductItem[] books = objectMapper.readValue(jsonArrayString, ProductItem[].class);
        ...
        mailMessage.setTo(orderDto.getEmail());
        mailMessage.setSubject("Invoice");
        mailMessage.setFrom("norply@hiashouse.com");
        mailMessage.setText("Layanan Pengiriman: \n \n"+orderDto.getOngkir()+"Biaya Pengiriman :"+kursIndonesia.format(orderDto.getOngkirPrice())+"Rincian Product :"+orderDto.getProductItem()+"\n \n Total Product : "+orderDto.getProductTotal()+"\n Total : "+kursIndonesia.format(orderDto.getTotal()));
...
//    }
    ...
    public ResponseEntity<?> getAddressByUserId(Pageable pageable) {
        ...
        List<JSONObject> listSub = new ArrayList<>();
        JSONObject result = new JSONObject();
        Page<Order> listHotProduct = orderService.getAllOrder(pageable);
        for(Order objects : listHotProduct) {
            JSONObject json = new JSONObject();
            JSONObject listUser = new JSONObject();
            json.put("orderId", objects.getId());
    ...
    @PostMapping("addTestimoni")
    public ResponseEntity<?> addTesti(@RequestBody TestimonialDto testimonialDto,Long userId,Long rating,String comment){
        JSONObject resp = new JSONObject();

        testimonialService.insertTestimonial(testimonialDto.getUserId(userId),testimonialDto.getRating(rating),testimonialDto.getComment(comment));
    ...
    @GetMapping("{id}/getTestiByUserId")
    public ResponseEntity<?> getTestimoni(@PathVariable(value="id") Long id) {
        ...
        List<JSONObject> listItem = new ArrayList<>();
        JSONObject result = new JSONObject();
        List<Testimonial> listHotProduct = testimonialService.getTestiByUserId(id);
